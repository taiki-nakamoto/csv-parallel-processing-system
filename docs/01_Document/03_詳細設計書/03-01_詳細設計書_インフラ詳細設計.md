...
```json
{
  ...
  "Statement": [
    ...
    },
    {
      ...
      "Resource": [
        "arn:aws:s3:::csv-output-{account-id}/results/*"
      ]
    }
  ]
}
...
```json
{
  ...
  "Statement": [
    ...
    },
    {
      ...
      "Resource": [
        "arn:aws:s3:::csv-input-{account-id}/incoming/*",
        "arn:aws:s3:::csv-input-{account-id}/processing/*"
      ]
    },
    {
...
### 4.1 csv-input-{account-id} バケットポリシー
...
```json
{
  ...
  "Statement": [
    ...
    },
    {
      ...
      "Resource": [
        "arn:aws:s3:::csv-input-{account-id}/processing/*",
        "arn:aws:s3:::csv-input-{account-id}/processed/*",
        "arn:aws:s3:::csv-input-{account-id}/failed/*"
      ]
    },
    {
      ...
      "Resource": [
        "arn:aws:s3:::csv-input-{account-id}/failed/*",
        "arn:aws:s3:::csv-input-{account-id}/.aws/*"
      ],
      "Condition": {
        "StringNotEquals": {
...
### 4.2 csv-output-{account-id} バケットポリシー
  ...
  "Statement": [
    {
      ...
      "Action": "s3:*",
      "Resource": [
        "arn:aws:s3:::csv-output-{account-id}/*",
        "arn:aws:s3:::csv-output-{account-id}"
      ],
      "Condition": {
        "Bool": {
